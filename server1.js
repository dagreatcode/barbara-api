...
app.post("/api/retroluxe", (req, res) => {
  ...
  connection.query(`INSERT INTO retroluxe (name, bin_location, description, img) VALUES ("New Item", 1, "relaxed", "")`, [req.body.name, req.body.bin_location, req.body.description, req.params.id], (err, data) => {
      if (err) {
        throw err;
      }
      res.redirect("/");
